...
def analyze():
    stand_by()
    show_camera()
    robot_say('Whats this thing? Give me 2 seconds!')
    time.sleep(2)

    robot_say('Trying to use Google to help me identify this thing!' )
    # robot_say('3')
    # time.sleep(1)
    robot_say('about to take a picture of it.')
    # time.sleep(1)
    # robot_say('1')
    robot_say('Picture taken, sending to skynet, i mean google')
